            ...
            <form action="insert_product.php" method="post" class="menu-list" id="order-form">
                <div class="container">
                    <div class="coffee-1">
                        ...
                        <div class="content">
                            <h2 class="product_name">Hot Coffee Latte</h2>
                ...
                <div class="container">
                    <div class="coffee-1">
                        ...
                        <div class="content">
                            <h2 class="product_name">Hot Americano</h2>
                ...
                <div class="container">
                    <div class="coffee-1">
                        ...
                        <div class="content">
                            <h2 class="product_name">Hot Cafe Mocha</h2>
                ...
                <div class="container">
                    <div class="coffee-1">
                        ...
                        <div class="content">
                            <h2 class="product_name">Hot Cappuccino</h2>
                            <p class="product_name">₱175.00</p>
                        </div>
                    </div>
                    <h2 class="sugar-title">Sugar Level</h2>
                    <div class="coffee-2">
                ...
                <div class="container">
                    <div class="coffee-1">
                        ...
                        <div class="content">
                            <h2 class="product_name">Hot Caramel Latte</h2>
                ...
                <div class="container">
                    <div class="coffee-1">
                        ...
                        <div class="content">
                            <h2 class="product_name">Hot Chocolate</h2>
                ...
                <div class="container">
                    <div class="coffee-1">
                        ...
                        <div class="content">
                            <h2 class="product_name">Hot Tea</h2>
                ...
                <div class="container">
                    <div class="coffee-1">
                        ...
                        <div class="content">
                            <h2 class="product_name">Hot Chocolate Mocha</h2>
                            <p class="product_price">₱250.00</p>
                        </div>
                    </div>
                    <h2 class="sugar-title">Sugar Level</h2>
                    <div class="coffee-2">
